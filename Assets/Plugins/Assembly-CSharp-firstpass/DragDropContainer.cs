...
public class DragDropContainer : MonoBehaviour
{
	...
	public void Reposition()
	{
		...
		MyGUIDragablePanel component = GetComponent<MyGUIDragablePanel>();
		component.SetBounds(base.transform.localPosition.x, cellWidth * (float)transform.childCount - 364f);
	}
}
