™äShader "Transparent/Cutout/Bumped Diffuse" {
Properties {
...
void main ()
{
  ...
  lowp vec4 c_5;
  c_5.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * (max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), xlv_TEXCOORD1)) * 2.00000));
  c_5.w = tmpvar_3;
...
void main ()
{
  ...
  tmpvar_2 = (texture2D (_MainTex, xlv_TEXCOORD0.xy) * _Color);
  lowp vec3 tmpvar_3;
  tmpvar_3 = ((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000);
  lowp float x_4;
  x_4 = (tmpvar_2.w - _Cutoff);
  if ((x_4 < 0.000000)) {
    discard;
  ...
  mediump vec3 lm_7;
  lowp vec3 tmpvar_8;
  tmpvar_8 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz);
  lm_7 = tmpvar_8;
  lowp vec3 tmpvar_9;
  tmpvar_9 = (2.00000 * texture2D (unity_LightmapInd, xlv_TEXCOORD1).xyz);
  scalePerBasisVector_6 = tmpvar_9;
  lm_7 = (lm_7 * dot (clamp ((mat3(0.816497, -0.408248, -0.408248, 0.000000, 0.707107, -0.707107, 0.577350, 0.577350, 0.577350) * normal_5), 0.000000, 1.00000), scalePerBasisVector_6));
...
void main ()
{
  ...
  tmpvar_5 = tmpvar_10;
  lowp vec4 c_11;
  c_11.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * ((max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), xlv_TEXCOORD1)) * tmpvar_5) * 2.00000));
  c_11.w = tmpvar_3;
...
void main ()
{
  ...
  mediump vec3 lm_13;
  lowp vec3 tmpvar_14;
  tmpvar_14 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz);
  lm_13 = tmpvar_14;
  lowp vec3 tmpvar_15;
  tmpvar_15 = (2.00000 * texture2D (unity_LightmapInd, xlv_TEXCOORD1).xyz);
  scalePerBasisVector_12 = tmpvar_15;
  lm_13 = (lm_13 * dot (clamp ((mat3(0.816497, -0.408248, -0.408248, 0.000000, 0.707107, -0.707107, 0.577350, 0.577350, 0.577350) * normal_11), 0.000000, 1.00000), scalePerBasisVector_12));
  lowp vec3 tmpvar_16;
  tmpvar_16 = vec3((tmpvar_5 * 2.00000));
...
void main ()
{
  ...
  tmpvar_34 = (max (vec4(0.000000, 0.000000, 0.000000, 0.000000), ((((tmpvar_30 * tmpvar_8.x) + (tmpvar_31 * tmpvar_8.y)) + (tmpvar_32 * tmpvar_8.z)) * inversesqrt(tmpvar_33))) * (1.0/((1.00000 + (tmpvar_33 * unity_4LightAtten0)))));
...
void main ()
{
  ...
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_7)).w) * 2.00000));
  c_8.w = tmpvar_4;
  c_1.xyz = c_8.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * (max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), lightDir_2)) * 2.00000));
  c_6.w = tmpvar_4;
  c_1.xyz = c_6.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = tmpvar_6;
  highp vec2 P_7;
  P_7 = ((xlv_TEXCOORD2.xy / xlv_TEXCOORD2.w) + 0.500000);
  highp float tmpvar_8;
  tmpvar_8 = dot (xlv_TEXCOORD2.xyz, xlv_TEXCOORD2.xyz);
  lowp float atten_9;
  atten_9 = ((float((xlv_TEXCOORD2.z > 0.000000)) * texture2D (_LightTexture0, P_7).w) * texture2D (_LightTextureB0, vec2(tmpvar_8)).w);
  lowp vec4 c_10;
  c_10.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), lightDir_2)) * atten_9) * 2.00000));
  c_10.w = tmpvar_4;
  c_1.xyz = c_10.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_7 = dot (xlv_TEXCOORD2, xlv_TEXCOORD2);
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_7)).w * textureCube (_LightTexture0, xlv_TEXCOORD2).w)) * 2.00000));
  c_8.w = tmpvar_4;
  c_1.xyz = c_8.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD1;
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD2).w) * 2.00000));
  c_6.w = tmpvar_4;
  c_1.xyz = c_6.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
