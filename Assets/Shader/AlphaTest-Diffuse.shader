жаShader "Transparent/Cutout/Diffuse" {
Properties {
...
void main ()
{
  ...
  lowp vec4 c_5;
  c_5.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * (max (0.000000, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * 2.00000));
  c_5.w = tmpvar_3;
...
void main ()
{
  ...
  tmpvar_5 = tmpvar_10;
  lowp vec4 c_11;
  c_11.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * ((max (0.000000, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * tmpvar_5) * 2.00000));
  c_11.w = tmpvar_3;
...
void main ()
{
  ...
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_7)).w) * 2.00000));
  c_8.w = tmpvar_4;
  c_1.xyz = c_8.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * (max (0.000000, dot (xlv_TEXCOORD1, lightDir_2)) * 2.00000));
  c_6.w = tmpvar_4;
  c_1.xyz = c_6.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_10;
  c_10.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (xlv_TEXCOORD1, lightDir_2)) * atten_9) * 2.00000));
  c_10.w = tmpvar_4;
  c_1.xyz = c_10.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_7 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (xlv_TEXCOORD1, lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_7)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)) * 2.00000));
  c_8.w = tmpvar_4;
  c_1.xyz = c_8.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD2;
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD3).w) * 2.00000));
  c_6.w = tmpvar_4;
  c_1.xyz = c_6.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
