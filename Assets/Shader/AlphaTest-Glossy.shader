òŒShader "Transparent/Cutout/Specular" {
Properties {
...
void main ()
{
  ...
  tmpvar_10 = max (0.000000, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz));
  mediump float tmpvar_11;
  tmpvar_11 = max (0.000000, dot (xlv_TEXCOORD1, normalize((_WorldSpaceLightPos0.xyz + viewDir_7))));
  nh_9 = tmpvar_11;
...
void main ()
{
  ...
  tmpvar_16 = max (0.000000, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz));
  mediump float tmpvar_17;
  tmpvar_17 = max (0.000000, dot (xlv_TEXCOORD1, normalize((_WorldSpaceLightPos0.xyz + viewDir_13))));
  nh_15 = tmpvar_17;
...
void main ()
{
  ...
  tmpvar_5 = tmpvar_10;
  c_1.xyz = ((tmpvar_2.xyz * _Color.xyz) * min ((2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_5 * 2.00000))));
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_27 = (c_1.xyz + (tmpvar_3 * min (tmpvar_13.xyz, tmpvar_26)));
  c_1.xyz = tmpvar_27;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
}
