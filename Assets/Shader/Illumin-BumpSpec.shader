буShader "Self-Illumin/Bumped Specular" {
Properties {
...
void main ()
{
  ...
  highp float nh_8;
  lowp float tmpvar_9;
  tmpvar_9 = max (0.000000, dot (tmpvar_4, xlv_TEXCOORD2));
  mediump float tmpvar_10;
  tmpvar_10 = max (0.000000, dot (tmpvar_4, normalize((xlv_TEXCOORD2 + viewDir_6))));
  nh_8 = tmpvar_10;
  ...
  tmpvar_13 = ((((tmpvar_3.xyz * _LightColor0.xyz) * tmpvar_9) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_12)) * 2.00000);
  c_7.xyz = tmpvar_13;
...
void main ()
{
  ...
  tmpvar_20 = (c_1.xyz + (tmpvar_3.xyz * tmpvar_6.xyz));
  c_1.xyz = tmpvar_20;
  c_1.w = tmpvar_3.w;
  c_1.xyz = (c_1.xyz + (tmpvar_3.xyz * texture2D (_Illum, xlv_TEXCOORD0.zw).w));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_15 = max (0.000000, dot (tmpvar_4, xlv_TEXCOORD2));
  mediump float tmpvar_16;
  tmpvar_16 = max (0.000000, dot (tmpvar_4, normalize((xlv_TEXCOORD2 + viewDir_12))));
  nh_14 = tmpvar_16;
  mediump float arg1_17;
  arg1_17 = (_Shininess * 128.000);
  ...
  tmpvar_19 = ((((tmpvar_3.xyz * _LightColor0.xyz) * tmpvar_15) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_18)) * (tmpvar_5 * 2.00000));
  c_13.xyz = tmpvar_19;
  highp float tmpvar_20;
...
void main ()
{
  ...
  tmpvar_27 = (c_1.xyz + (tmpvar_3.xyz * min (tmpvar_12.xyz, tmpvar_26)));
  c_1.xyz = tmpvar_27;
  c_1.w = tmpvar_3.w;
  c_1.xyz = (c_1.xyz + (tmpvar_3.xyz * texture2D (_Illum, xlv_TEXCOORD0.zw).w));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_11 = max (0.000000, dot (tmpvar_5, lightDir_2));
  mediump float tmpvar_12;
  tmpvar_12 = max (0.000000, dot (tmpvar_5, normalize((lightDir_2 + normalize(xlv_TEXCOORD2)))));
  nh_10 = tmpvar_12;
...
void main ()
{
  ...
  highp float nh_7;
  lowp float tmpvar_8;
  tmpvar_8 = max (0.000000, dot (tmpvar_5, lightDir_2));
  mediump float tmpvar_9;
  tmpvar_9 = max (0.000000, dot (tmpvar_5, normalize((lightDir_2 + normalize(xlv_TEXCOORD2)))));
  nh_7 = tmpvar_9;
  ...
  highp vec3 tmpvar_12;
  tmpvar_12 = ((((tmpvar_4.xyz * _LightColor0.xyz) * tmpvar_8) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_11)) * 2.00000);
  c_6.xyz = tmpvar_12;
...
void main ()
{
  ...
  lightDir_2 = tmpvar_6;
  highp vec2 P_7;
  P_7 = ((xlv_TEXCOORD3.xy / xlv_TEXCOORD3.w) + 0.500000);
  highp float tmpvar_8;
  tmpvar_8 = dot (xlv_TEXCOORD3.xyz, xlv_TEXCOORD3.xyz);
  lowp float atten_9;
  atten_9 = ((float((xlv_TEXCOORD3.z > 0.000000)) * texture2D (_LightTexture0, P_7).w) * texture2D (_LightTextureB0, vec2(tmpvar_8)).w);
  lowp vec4 c_10;
  highp float nh_11;
  lowp float tmpvar_12;
  tmpvar_12 = max (0.000000, dot (tmpvar_5, lightDir_2));
  mediump float tmpvar_13;
  tmpvar_13 = max (0.000000, dot (tmpvar_5, normalize((lightDir_2 + normalize(xlv_TEXCOORD2)))));
  nh_11 = tmpvar_13;
  ...
  tmpvar_16 = ((((tmpvar_4.xyz * _LightColor0.xyz) * tmpvar_12) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_15)) * (atten_9 * 2.00000));
  c_10.xyz = tmpvar_16;
...
void main ()
{
  ...
  highp float nh_8;
  lowp float tmpvar_9;
  tmpvar_9 = max (0.000000, dot (tmpvar_5, lightDir_2));
  mediump float tmpvar_10;
  tmpvar_10 = max (0.000000, dot (tmpvar_5, normalize((lightDir_2 + normalize(xlv_TEXCOORD2)))));
  nh_8 = tmpvar_10;
  mediump float arg1_11;
  arg1_11 = (_Shininess * 128.000);
  highp float tmpvar_12;
  ...
  highp vec3 tmpvar_13;
  tmpvar_13 = ((((tmpvar_4.xyz * _LightColor0.xyz) * tmpvar_9) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_12)) * (atten_6 * 2.00000));
  c_7.xyz = tmpvar_13;
  highp float tmpvar_14;
