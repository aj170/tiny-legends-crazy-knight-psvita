угShader "Self-Illumin/Bumped Diffuse" {
Properties {
...
void main ()
{
  ...
  lowp vec4 c_3;
  c_3.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * (max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD1).xyz * 2.00000) - 1.00000), xlv_TEXCOORD2)) * 2.00000));
  c_3.w = tmpvar_2.w;
  c_1.w = c_3.w;
...
void main ()
{
  ...
  lowp vec4 tmpvar_2;
  tmpvar_2 = (texture2D (_MainTex, xlv_TEXCOORD0.xy) * _Color);
  c_1.xyz = (tmpvar_2.xyz * (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz));
  c_1.w = tmpvar_2.w;
  c_1.xyz = (c_1.xyz + (tmpvar_2.xyz * texture2D (_Illum, xlv_TEXCOORD0.zw).w));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_2 = (texture2D (_MainTex, xlv_TEXCOORD0.xy) * _Color);
  lowp vec3 tmpvar_3;
  tmpvar_3 = ((texture2D (_BumpMap, xlv_TEXCOORD1).xyz * 2.00000) - 1.00000);
  mediump vec3 normal_4;
  normal_4 = tmpvar_3;
  mediump vec3 scalePerBasisVector_5;
  mediump vec3 lm_6;
  lowp vec3 tmpvar_7;
  tmpvar_7 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lm_6 = tmpvar_7;
  lowp vec3 tmpvar_8;
  tmpvar_8 = (2.00000 * texture2D (unity_LightmapInd, xlv_TEXCOORD2).xyz);
  scalePerBasisVector_5 = tmpvar_8;
  lm_6 = (lm_6 * dot (clamp ((mat3(0.816497, -0.408248, -0.408248, 0.000000, 0.707107, -0.707107, 0.577350, 0.577350, 0.577350) * normal_4), 0.000000, 1.00000), scalePerBasisVector_5));
  mediump vec3 tmpvar_9;
  tmpvar_9 = (tmpvar_2.xyz * lm_6);
  c_1.xyz = tmpvar_9;
  c_1.w = tmpvar_2.w;
  c_1.xyz = (c_1.xyz + (tmpvar_2.xyz * texture2D (_Illum, xlv_TEXCOORD0.zw).w));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_3 = tmpvar_8;
  lowp vec4 c_9;
  c_9.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * ((max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD1).xyz * 2.00000) - 1.00000), xlv_TEXCOORD2)) * tmpvar_3) * 2.00000));
  c_9.w = tmpvar_2.w;
  c_1.w = c_9.w;
  c_1.xyz = (c_9.xyz + (tmpvar_2.xyz * xlv_TEXCOORD3));
  c_1.xyz = (c_1.xyz + (tmpvar_2.xyz * texture2D (_Illum, xlv_TEXCOORD0.zw).w));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_3 = tmpvar_8;
  c_1.xyz = (tmpvar_2.xyz * min ((2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz), vec3((tmpvar_3 * 2.00000))));
  c_1.w = tmpvar_2.w;
  c_1.xyz = (c_1.xyz + (tmpvar_2.xyz * texture2D (_Illum, xlv_TEXCOORD0.zw).w));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec3 tmpvar_15;
  tmpvar_15 = vec3((tmpvar_4 * 2.00000));
...
void main ()
{
  ...
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_5)).w) * 2.00000));
  c_6.w = tmpvar_3.w;
  c_1.xyz = c_6.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_4;
  c_4.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * (max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), lightDir_2)) * 2.00000));
  c_4.w = tmpvar_3.w;
  c_1.xyz = c_4.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = tmpvar_4;
  highp vec2 P_5;
  P_5 = ((xlv_TEXCOORD2.xy / xlv_TEXCOORD2.w) + 0.500000);
  highp float tmpvar_6;
  tmpvar_6 = dot (xlv_TEXCOORD2.xyz, xlv_TEXCOORD2.xyz);
  lowp float atten_7;
  atten_7 = ((float((xlv_TEXCOORD2.z > 0.000000)) * texture2D (_LightTexture0, P_5).w) * texture2D (_LightTextureB0, vec2(tmpvar_6)).w);
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), lightDir_2)) * atten_7) * 2.00000));
  c_8.w = tmpvar_3.w;
  c_1.xyz = c_8.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_5 = dot (xlv_TEXCOORD2, xlv_TEXCOORD2);
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_5)).w * textureCube (_LightTexture0, xlv_TEXCOORD2).w)) * 2.00000));
  c_6.w = tmpvar_3.w;
  c_1.xyz = c_6.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD1;
  lowp vec4 c_4;
  c_4.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.000000, dot (((texture2D (_BumpMap, xlv_TEXCOORD0.zw).xyz * 2.00000) - 1.00000), lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD2).w) * 2.00000));
  c_4.w = tmpvar_3.w;
  c_1.xyz = c_4.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
