...
void main ()
{
  ...
  highp float nh_8;
  lowp float tmpvar_9;
  tmpvar_9 = max (0.000000, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz));
  mediump float tmpvar_10;
  tmpvar_10 = max (0.000000, dot (xlv_TEXCOORD1, normalize((_WorldSpaceLightPos0.xyz + viewDir_6))));
  nh_8 = tmpvar_10;
  ...
  tmpvar_13 = ((((tmpvar_3 * _LightColor0.xyz) * tmpvar_9) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_12)) * 2.00000);
  c_7.xyz = tmpvar_13;
  highp float tmpvar_14;
...
void main ()
{
  ...
  tmpvar_15 = max (0.000000, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz));
  mediump float tmpvar_16;
  tmpvar_16 = max (0.000000, dot (xlv_TEXCOORD1, normalize((_WorldSpaceLightPos0.xyz + viewDir_12))));
  nh_14 = tmpvar_16;
  ...
  tmpvar_19 = ((((tmpvar_3 * _LightColor0.xyz) * tmpvar_15) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_18)) * (tmpvar_5 * 2.00000));
  c_13.xyz = tmpvar_19;
...
void main ()
{
  ...
  tmpvar_15 = ((((tmpvar_4 * _LightColor0.xyz) * tmpvar_11) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_14)) * (atten_8 * 2.00000));
  c_9.xyz = tmpvar_15;
...
void main ()
{
  ...
  tmpvar_12 = ((((tmpvar_4 * _LightColor0.xyz) * tmpvar_8) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_11)) * 2.00000);
  c_6.xyz = tmpvar_12;
  highp float tmpvar_13;
...
void main ()
{
  ...
  lightDir_2 = tmpvar_6;
  highp vec2 P_7;
  P_7 = ((xlv_TEXCOORD4.xy / xlv_TEXCOORD4.w) + 0.500000);
  highp float tmpvar_8;
  tmpvar_8 = dot (xlv_TEXCOORD4.xyz, xlv_TEXCOORD4.xyz);
  lowp float atten_9;
  atten_9 = ((float((xlv_TEXCOORD4.z > 0.000000)) * texture2D (_LightTexture0, P_7).w) * texture2D (_LightTextureB0, vec2(tmpvar_8)).w);
  lowp vec4 c_10;
  highp float nh_11;
...
void main ()
{
  ...
  highp vec3 tmpvar_13;
  tmpvar_13 = ((((tmpvar_4 * _LightColor0.xyz) * tmpvar_9) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_12)) * (atten_6 * 2.00000));
  c_7.xyz = tmpvar_13;
  highp float tmpvar_14;
