...
void main ()
{
  ...
  lowp vec4 c_13;
  c_13.xyz = ((tmpvar_12.xyz * _LightColor0.xyz) * (max (0.000000, dot (((texture2D (_BumpMap, tmpvar_11).xyz * 2.00000) - 1.00000), xlv_TEXCOORD2)) * 2.00000));
  c_13.w = tmpvar_12.w;
  c_1.w = c_13.w;
  c_1.xyz = (c_13.xyz + (tmpvar_12.xyz * xlv_TEXCOORD3));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_13 = tmpvar_18;
  lowp vec4 c_19;
  c_19.xyz = ((tmpvar_12.xyz * _LightColor0.xyz) * ((max (0.000000, dot (((texture2D (_BumpMap, tmpvar_11).xyz * 2.00000) - 1.00000), xlv_TEXCOORD2)) * tmpvar_13) * 2.00000));
  c_19.w = tmpvar_12.w;
  c_1.w = c_19.w;
  c_1.xyz = (c_19.xyz + (tmpvar_12.xyz * xlv_TEXCOORD3));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_11 = tmpvar_16;
  c_1.xyz = (tmpvar_10.xyz * min ((2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz), vec3((tmpvar_11 * 2.00000))));
  c_1.w = tmpvar_10.w;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec3 tmpvar_25;
  tmpvar_25 = vec3((tmpvar_14 * 2.00000));
  mediump vec3 tmpvar_26;
  tmpvar_26 = (tmpvar_12.xyz * min (lm_22, tmpvar_25));
  c_1.xyz = tmpvar_26;
  c_1.w = tmpvar_12.w;
  gl_FragData[0] = c_1;
}
