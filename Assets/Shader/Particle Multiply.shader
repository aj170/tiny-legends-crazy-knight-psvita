...
void main ()
{
  ...
  tmpvar_4 = mix (vec4(1.00000, 1.00000, 1.00000, 1.00000), prev_2, prev_2.wwww);
  tmpvar_1 = tmpvar_4;
...
void main ()
{
  ...
  tmpvar_6 = (xlv_COLOR.w * clamp ((_InvFade * ((1.0/(((_ZBufferParams.z * z_5) + _ZBufferParams.w))) - xlv_TEXCOORD1.z)), 0.000000, 1.00000));
  tmpvar_2.w = tmpvar_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = (tmpvar_2 * texture2D (_MainTex, xlv_TEXCOORD0));
  prev_3 = tmpvar_7;
  mediump vec4 tmpvar_8;
  tmpvar_8 = mix (vec4(1.00000, 1.00000, 1.00000, 1.00000), prev_3, prev_3.wwww);
  tmpvar_1 = tmpvar_8;
  gl_FragData[0] = tmpvar_1;
}
