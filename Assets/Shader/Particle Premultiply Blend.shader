œ"Shader "Particles/Alpha Blended Premultiply" {
Properties {
...
void main ()
{
  gl_FragData[0] = ((xlv_COLOR * texture2D (_MainTex, xlv_TEXCOORD0)) * xlv_COLOR.w);
}
...
void main ()
{
  ...
  tmpvar_1.w = tmpvar_4;
  gl_FragData[0] = ((tmpvar_1 * texture2D (_MainTex, xlv_TEXCOORD0)) * tmpvar_1.w);
}
