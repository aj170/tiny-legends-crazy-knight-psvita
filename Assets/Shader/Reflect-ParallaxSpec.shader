МаShader "Reflective/Parallax Specular" {
Properties {
...
void main ()
{
  ...
  tmpvar_31 = max (0.000000, dot (tmpvar_22, xlv_TEXCOORD5));
  mediump float tmpvar_32;
  tmpvar_32 = max (0.000000, dot (tmpvar_22, normalize((xlv_TEXCOORD5 + viewDir_28))));
  nh_30 = tmpvar_32;
  ...
  tmpvar_35 = ((((tmpvar_21 * _LightColor0.xyz) * tmpvar_31) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_34)) * 2.00000);
  c_29.xyz = tmpvar_35;
  highp float tmpvar_36;
...
void main ()
{
  ...
  c_1.xyz = ((tmpvar_20.xyz * _Color.xyz) * (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz));
...
void main ()
{
  ...
  mediump vec3 lm_33;
  lowp vec3 tmpvar_34;
  tmpvar_34 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz);
  lm_33 = tmpvar_34;
  lowp vec3 tmpvar_35;
  tmpvar_35 = (2.00000 * texture2D (unity_LightmapInd, xlv_TEXCOORD5).xyz);
  scalePerBasisVector_32 = tmpvar_35;
  lm_33 = (lm_33 * dot (clamp ((mat3(0.816497, -0.408248, -0.408248, 0.000000, 0.707107, -0.707107, 0.577350, 0.577350, 0.577350) * normal_31), 0.000000, 1.00000), scalePerBasisVector_32));
  mediump float tmpvar_36;
  tmpvar_36 = max (0.000000, dot (tmpvar_22, normalize((normalize((((scalePerBasisVector_32.x * vec3(0.816497, 0.000000, 0.577350)) + (scalePerBasisVector_32.y * vec3(-0.408248, 0.707107, 0.577350))) + (scalePerBasisVector_32.z * vec3(-0.408248, -0.707107, 0.577350)))) + viewDir_28))));
  nh_30 = tmpvar_36;
  highp float tmpvar_37;
  mediump float arg1_38;
  arg1_38 = (_Shininess * 128.000);
  tmpvar_37 = pow (nh_30, arg1_38);
  highp vec3 tmpvar_39;
  tmpvar_39 = (((lm_33 * _SpecColor.xyz) * tmpvar_20.w) * tmpvar_37);
  specColor_29 = tmpvar_39;
  ...
  tmpvar_41 = (c_1.xyz + (tmpvar_21 * tmpvar_27.xyz));
  c_1.xyz = tmpvar_41;
...
void main ()
{
  ...
  tmpvar_37 = max (0.000000, dot (tmpvar_22, xlv_TEXCOORD5));
  mediump float tmpvar_38;
  tmpvar_38 = max (0.000000, dot (tmpvar_22, normalize((xlv_TEXCOORD5 + viewDir_34))));
  nh_36 = tmpvar_38;
  mediump float arg1_39;
  arg1_39 = (_Shininess * 128.000);
  highp float tmpvar_40;
  tmpvar_40 = (pow (nh_36, arg1_39) * tmpvar_20.w);
  highp vec3 tmpvar_41;
  tmpvar_41 = ((((tmpvar_21 * _LightColor0.xyz) * tmpvar_37) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_40)) * (tmpvar_27 * 2.00000));
  c_35.xyz = tmpvar_41;
...
void main ()
{
  ...
  tmpvar_25 = tmpvar_30;
  c_1.xyz = ((tmpvar_20.xyz * _Color.xyz) * min ((2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz), vec3((tmpvar_25 * 2.00000))));
  c_1.w = (tmpvar_24.w * _ReflectColor.w);
  c_1.xyz = (c_1.xyz + (tmpvar_24.xyz * _ReflectColor.xyz));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec3 lm_39;
  lowp vec3 tmpvar_40;
  tmpvar_40 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz);
  lm_39 = tmpvar_40;
  lowp vec3 tmpvar_41;
  tmpvar_41 = (2.00000 * texture2D (unity_LightmapInd, xlv_TEXCOORD5).xyz);
  scalePerBasisVector_38 = tmpvar_41;
  lm_39 = (lm_39 * dot (clamp ((mat3(0.816497, -0.408248, -0.408248, 0.000000, 0.707107, -0.707107, 0.577350, 0.577350, 0.577350) * normal_37), 0.000000, 1.00000), scalePerBasisVector_38));
  mediump float tmpvar_42;
  tmpvar_42 = max (0.000000, dot (tmpvar_22, normalize((normalize((((scalePerBasisVector_38.x * vec3(0.816497, 0.000000, 0.577350)) + (scalePerBasisVector_38.y * vec3(-0.408248, 0.707107, 0.577350))) + (scalePerBasisVector_38.z * vec3(-0.408248, -0.707107, 0.577350)))) + viewDir_34))));
  nh_36 = tmpvar_42;
  highp float tmpvar_43;
  mediump float arg1_44;
  arg1_44 = (_Shininess * 128.000);
  tmpvar_43 = pow (nh_36, arg1_44);
  highp vec3 tmpvar_45;
  tmpvar_45 = (((lm_39 * _SpecColor.xyz) * tmpvar_20.w) * tmpvar_43);
  specColor_35 = tmpvar_45;
  ...
  lowp vec3 tmpvar_47;
  tmpvar_47 = vec3((tmpvar_26 * 2.00000));
  mediump vec3 tmpvar_48;
  tmpvar_48 = (c_1.xyz + (tmpvar_21 * min (tmpvar_33.xyz, tmpvar_47)));
  c_1.xyz = tmpvar_48;
  c_1.w = (tmpvar_25.w * _ReflectColor.w);
  c_1.xyz = (c_1.xyz + (tmpvar_25.xyz * _ReflectColor.xyz));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec3 tmpvar_16;
  tmpvar_16 = ((texture2D (_BumpMap, tmpvar_13).xyz * 2.00000) - 1.00000);
  ...
  tmpvar_29 = ((((tmpvar_15 * _LightColor0.xyz) * tmpvar_25) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_28)) * (atten_22 * 2.00000));
  c_23.xyz = tmpvar_29;
  highp float tmpvar_30;
...
void main ()
{
  ...
  tmpvar_23 = max (0.000000, dot (tmpvar_16, normalize((lightDir_2 + viewDir_19))));
  nh_21 = tmpvar_23;
  ...
  highp vec3 tmpvar_26;
  tmpvar_26 = ((((tmpvar_15 * _LightColor0.xyz) * tmpvar_22) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_25)) * 2.00000);
  c_20.xyz = tmpvar_26;
...
void main ()
{
  ...
  tmpvar_19 = normalize(xlv_TEXCOORD1);
  highp vec2 P_20;
  P_20 = ((xlv_TEXCOORD3.xy / xlv_TEXCOORD3.w) + 0.500000);
  highp float tmpvar_21;
  tmpvar_21 = dot (xlv_TEXCOORD3.xyz, xlv_TEXCOORD3.xyz);
  mediump vec3 viewDir_22;
  viewDir_22 = tmpvar_19;
  lowp float atten_23;
  atten_23 = ((float((xlv_TEXCOORD3.z > 0.000000)) * texture2D (_LightTexture0, P_20).w) * texture2D (_LightTextureB0, vec2(tmpvar_21)).w);
  lowp vec4 c_24;
  highp float nh_25;
  lowp float tmpvar_26;
  tmpvar_26 = max (0.000000, dot (tmpvar_16, lightDir_2));
  mediump float tmpvar_27;
  tmpvar_27 = max (0.000000, dot (tmpvar_16, normalize((lightDir_2 + viewDir_22))));
  nh_25 = tmpvar_27;
  ...
  tmpvar_30 = ((((tmpvar_15 * _LightColor0.xyz) * tmpvar_26) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_29)) * (atten_23 * 2.00000));
  c_24.xyz = tmpvar_30;
  highp float tmpvar_31;
...
void main ()
{
  ...
  tmpvar_23 = max (0.000000, dot (tmpvar_16, lightDir_2));
  mediump float tmpvar_24;
  tmpvar_24 = max (0.000000, dot (tmpvar_16, normalize((lightDir_2 + viewDir_19))));
  nh_22 = tmpvar_24;
  ...
  highp vec3 tmpvar_27;
  tmpvar_27 = ((((tmpvar_15 * _LightColor0.xyz) * tmpvar_23) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_26)) * (atten_20 * 2.00000));
  c_21.xyz = tmpvar_27;
  highp float tmpvar_28;
